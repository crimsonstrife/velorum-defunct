...
TArray<UObject*> UBluhatLibrary::FilterEqual(TArray<UObject*> Array, FName Property, float Value)
{
...
TArray<UObject*> UBluhatLibrary::FilterDifferent(TArray<UObject*> Array, FName Property, float Value)
{
...
TArray<UObject*> UBluhatLibrary::FilterGreater(TArray<UObject*> Array, FName Property, float Value)
{
	TArray<UObject*> FilteredArray;
...
TArray<UObject*> UBluhatLibrary::FilterGreaterEqual(TArray<UObject*> Array, FName Property, float Value)
{
...
TArray<UObject*> UBluhatLibrary::FilterSmaller(TArray<UObject*> Array, FName Property, float Value)
{
...
TArray<UObject*> UBluhatLibrary::FilterSmallerEqual(TArray<UObject*> Array, FName Property, float Value)
{
...
void UBluhatLibrary::SortWithProperty(TArray<UObject*> Array, FName Property)
{
	uint32 ArraySize = Array.Num();
	QuickSort(Array, Property, 0, ArraySize - 1);
}
TArray<UObject*> UBluhatLibrary::Reverse(TArray<UObject*> Array)
{
...
UObject* UBluhatLibrary::MaxWithProperty(TArray<UObject*> Array, FName Property)
{
...
UObject* UBluhatLibrary::MinWithProperty(TArray<UObject*> Array, FName Property)
{
...
bool UBluhatLibrary::CompareProperties(UObject* Object1, UProperty* Property1, UObject* Object2, UProperty* Property2)
{
...
UProperty* UBluhatLibrary::GetProperty(UObject *Object, FName DesiredProperty) {
...
void UBluhatLibrary::QuickSort(TArray<UObject*> Array, FName DesiredProperty, uint32 Left, uint32 Right) {
...
float UBluhatLibrary::UPropertyToFloat(UObject* Object, UProperty* Property) {
