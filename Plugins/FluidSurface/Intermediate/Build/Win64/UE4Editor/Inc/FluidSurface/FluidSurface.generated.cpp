...
void EmptyLinkFunctionForGeneratedCodeFluidSurface() {}
	...
	IMPLEMENT_CLASS(AFluidSurfaceActor, 848005306);
static class UEnum* EFluidGridType_StaticEnum()
{
	extern FLUIDSURFACE_API class UPackage* Z_Construct_UPackage__Script_FluidSurface();
	static class UEnum* Singleton = NULL;
	if (!Singleton)
	{
		extern FLUIDSURFACE_API class UEnum* Z_Construct_UEnum_FluidSurface_EFluidGridType();
		Singleton = GetStaticEnum(Z_Construct_UEnum_FluidSurface_EFluidGridType, Z_Construct_UPackage__Script_FluidSurface(), TEXT("EFluidGridType"));
	}
	return Singleton;
}
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EFluidGridType(EFluidGridType_StaticEnum, TEXT("/Script/FluidSurface"), TEXT("EFluidGridType"), false, nullptr, nullptr);
class UScriptStruct* FRangedValues::StaticStruct()
{
	...
	if (!Singleton)
	{
		...
		Singleton = GetStaticStruct(Z_Construct_UScriptStruct_FRangedValues, Z_Construct_UPackage__Script_FluidSurface(), TEXT("RangedValues"), sizeof(FRangedValues), Get_Z_Construct_UScriptStruct_FRangedValues_CRC());
	}
	return Singleton;
}
static FCompiledInDeferStruct Z_CompiledInDeferStruct_UScriptStruct_FRangedValues(FRangedValues::StaticStruct, TEXT("/Script/FluidSurface"), TEXT("RangedValues"), false, nullptr, nullptr);
...
// Cross Module References
	...
	FLUIDSURFACE_API class UPackage* Z_Construct_UPackage__Script_FluidSurface();
	...
	UClass* Z_Construct_UClass_AFluidSurfaceActor()
	{
		...
		if (!OuterClass)
		{
			...
			Z_Construct_UPackage__Script_FluidSurface();
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				UProperty* NewProp_FluidSurfaceComponent = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("FluidSurfaceComponent"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(FluidSurfaceComponent, AFluidSurfaceActor), 0x00100000000a001d, Z_Construct_UClass_UFluidSurfaceComponent_NoRegister());
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	static FCompiledInDefer Z_CompiledInDefer_UClass_AFluidSurfaceActor(Z_Construct_UClass_AFluidSurfaceActor, &AFluidSurfaceActor::StaticClass, TEXT("AFluidSurfaceActor"), false, nullptr, nullptr);
	DEFINE_VTABLE_PTR_HELPER_CTOR(AFluidSurfaceActor);
	UEnum* Z_Construct_UEnum_FluidSurface_EFluidGridType()
	{
		UPackage* Outer=Z_Construct_UPackage__Script_FluidSurface();
		extern uint32 Get_Z_Construct_UEnum_FluidSurface_EFluidGridType_CRC();
		static UEnum* ReturnEnum = FindExistingEnumIfHotReloadOrDynamic(Outer, TEXT("EFluidGridType"), 0, Get_Z_Construct_UEnum_FluidSurface_EFluidGridType_CRC(), false);
		if (!ReturnEnum)
		{
			ReturnEnum = new(EC_InternalUseOnlyConstructor, Outer, TEXT("EFluidGridType"), RF_Public|RF_Transient|RF_MarkAsNative) UEnum(FObjectInitializer());
			...
			ReturnEnum->CppType = TEXT("EFluidGridType::Type");
#if WITH_METADATA
	...
	uint32 Get_Z_Construct_UEnum_FluidSurface_EFluidGridType_CRC() { return 622991491U; }
	UScriptStruct* Z_Construct_UScriptStruct_FRangedValues()
	{
		UPackage* Outer = Z_Construct_UPackage__Script_FluidSurface();
		extern uint32 Get_Z_Construct_UScriptStruct_FRangedValues_CRC();
		static UScriptStruct* ReturnStruct = FindExistingStructIfHotReloadOrDynamic(Outer, TEXT("RangedValues"), sizeof(FRangedValues), Get_Z_Construct_UScriptStruct_FRangedValues_CRC(), false);
		if (!ReturnStruct)
		{
			ReturnStruct = new(EC_InternalUseOnlyConstructor, Outer, TEXT("RangedValues"), RF_Public|RF_Transient|RF_MarkAsNative) UScriptStruct(FObjectInitializer(), NULL, new UScriptStruct::TCppStructOps<FRangedValues>, EStructFlags(0x00000001));
			UProperty* NewProp_MaxValue = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("MaxValue"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(MaxValue, FRangedValues), 0x0010000000000005);
			UProperty* NewProp_MinValue = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("MinValue"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(MinValue, FRangedValues), 0x0010000000000005);
			ReturnStruct->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnStruct->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnStruct, TEXT("BlueprintType"), TEXT("true"));
			MetaData->SetValue(ReturnStruct, TEXT("ModuleRelativePath"), TEXT("Public/FluidSurfaceComponent.h"));
	...
	uint32 Get_Z_Construct_UScriptStruct_FRangedValues_CRC() { return 140464680U; }
	UFunction* Z_Construct_UFunction_UFluidSurfaceComponent_ComponentTouched()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("ComponentTouched"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x00420401, 65535, sizeof(FluidSurfaceComponent_eventComponentTouched_Parms));
			UProperty* NewProp_SweepResult = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("SweepResult"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(SweepResult, FluidSurfaceComponent_eventComponentTouched_Parms), 0x0010008008000182, Z_Construct_UScriptStruct_FHitResult());
			CPP_BOOL_PROPERTY_BITMASK_STRUCT(bFromSweep, FluidSurfaceComponent_eventComponentTouched_Parms, bool);
			UProperty* NewProp_bFromSweep = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("bFromSweep"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(bFromSweep, FluidSurfaceComponent_eventComponentTouched_Parms), 0x0010000000000080, CPP_BOOL_PROPERTY_BITMASK(bFromSweep, FluidSurfaceComponent_eventComponentTouched_Parms), sizeof(bool), true);
			UProperty* NewProp_OtherBodyIndex = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("OtherBodyIndex"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(OtherBodyIndex, FluidSurfaceComponent_eventComponentTouched_Parms), 0x0010000000000080);
			UProperty* NewProp_OtherComp = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("OtherComp"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(OtherComp, FluidSurfaceComponent_eventComponentTouched_Parms), 0x0010000000080080, Z_Construct_UClass_UPrimitiveComponent_NoRegister());
			UProperty* NewProp_Other = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Other"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(Other, FluidSurfaceComponent_eventComponentTouched_Parms), 0x0010000000000080, Z_Construct_UClass_AActor_NoRegister());
			ReturnFunction->Bind();
	...
	UFunction* Z_Construct_UFunction_UFluidSurfaceComponent_Pling()
	{
		...
		if (!ReturnFunction)
		{
			ReturnFunction = new(EC_InternalUseOnlyConstructor, Outer, TEXT("Pling"), RF_Public|RF_Transient|RF_MarkAsNative) UFunction(FObjectInitializer(), NULL, 0x04C20401, 65535, sizeof(FluidSurfaceComponent_eventPling_Parms));
			UProperty* NewProp_Radius = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Radius"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(Radius, FluidSurfaceComponent_eventPling_Parms), 0x0010000000000080);
			UProperty* NewProp_Strength = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Strength"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(Strength, FluidSurfaceComponent_eventPling_Parms), 0x0010000000000080);
			UProperty* NewProp_Position = new(EC_InternalUseOnlyConstructor, ReturnFunction, TEXT("Position"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(Position, FluidSurfaceComponent_eventPling_Parms), 0x0010000008000182, Z_Construct_UScriptStruct_FVector());
			ReturnFunction->Bind();
			ReturnFunction->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnFunction->GetOutermost()->GetMetaData();
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				UProperty* NewProp_FluidMaterial = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("FluidMaterial"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(FluidMaterial, UFluidSurfaceComponent), 0x0010000000000001, Z_Construct_UClass_UMaterialInterface_NoRegister());
				UProperty* NewProp_BodySetup = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("BodySetup"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(BodySetup, UFluidSurfaceComponent), 0x0010000000202000, Z_Construct_UClass_UBodySetup_NoRegister());
				UProperty* NewProp_Modifiers = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("Modifiers"), RF_Public|RF_Transient|RF_MarkAsNative) UArrayProperty(CPP_PROPERTY_BASE(Modifiers, UFluidSurfaceComponent), 0x0010000000000000);
				UProperty* NewProp_Modifiers_Inner = new(EC_InternalUseOnlyConstructor, NewProp_Modifiers, TEXT("Modifiers"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(FObjectInitializer(), EC_CppProperty, 0, 0x0000000000000000, Z_Construct_UClass_AFluidSurfaceModifier_NoRegister());
				UProperty* NewProp_TessellationRatio = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("TessellationRatio"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(TessellationRatio, UFluidSurfaceComponent), 0x0010000000000001);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(BuildTessellationData, UFluidSurfaceComponent, bool);
				UProperty* NewProp_BuildTessellationData = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("BuildTessellationData"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(BuildTessellationData, UFluidSurfaceComponent), 0x0010000000000001, CPP_BOOL_PROPERTY_BITMASK(BuildTessellationData, UFluidSurfaceComponent), sizeof(bool), true);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(UpdateComponent, UFluidSurfaceComponent, bool);
				UProperty* NewProp_UpdateComponent = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("UpdateComponent"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(UpdateComponent, UFluidSurfaceComponent), 0x0010000000000001, CPP_BOOL_PROPERTY_BITMASK(UpdateComponent, UFluidSurfaceComponent), sizeof(bool), true);
				UProperty* NewProp_FluidColor = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("FluidColor"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(FluidColor, UFluidSurfaceComponent), 0x0010000000000000, Z_Construct_UScriptStruct_FColor());
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(OrientTouchEffect, UFluidSurfaceComponent, bool);
				UProperty* NewProp_OrientTouchEffect = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("OrientTouchEffect"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(OrientTouchEffect, UFluidSurfaceComponent), 0x0010000000000005, CPP_BOOL_PROPERTY_BITMASK(OrientTouchEffect, UFluidSurfaceComponent), sizeof(bool), true);
				UProperty* NewProp_TouchEffect = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("TouchEffect"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(TouchEffect, UFluidSurfaceComponent), 0x0010000000000005, Z_Construct_UClass_UParticleSystem_NoRegister());
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(OrientShootEffect, UFluidSurfaceComponent, bool);
				UProperty* NewProp_OrientShootEffect = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("OrientShootEffect"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(OrientShootEffect, UFluidSurfaceComponent), 0x0010000000000005, CPP_BOOL_PROPERTY_BITMASK(OrientShootEffect, UFluidSurfaceComponent), sizeof(bool), true);
				UProperty* NewProp_ShootEffect = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ShootEffect"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(ShootEffect, UFluidSurfaceComponent), 0x0010000000000005, Z_Construct_UClass_UParticleSystem_NoRegister());
				UProperty* NewProp_RippleVelocityFactor = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("RippleVelocityFactor"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(RippleVelocityFactor, UFluidSurfaceComponent), 0x0010000000000005);
				UProperty* NewProp_TouchStrength = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("TouchStrength"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(TouchStrength, UFluidSurfaceComponent), 0x0010000000000005);
				UProperty* NewProp_ShootRadius = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ShootRadius"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(ShootRadius, UFluidSurfaceComponent), 0x0010000000000005);
				UProperty* NewProp_ShootStrength = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("ShootStrength"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(ShootStrength, UFluidSurfaceComponent), 0x0010000000000005);
				UProperty* NewProp_TestRippleRadius = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("TestRippleRadius"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(TestRippleRadius, UFluidSurfaceComponent), 0x0010000000000005);
				UProperty* NewProp_TestRippleStrength = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("TestRippleStrength"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(TestRippleStrength, UFluidSurfaceComponent), 0x0010000000000005);
				UProperty* NewProp_TestRippleSpeed = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("TestRippleSpeed"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(TestRippleSpeed, UFluidSurfaceComponent), 0x0010000000000005);
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(TestRipple, UFluidSurfaceComponent, bool);
				UProperty* NewProp_TestRipple = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("TestRipple"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(TestRipple, UFluidSurfaceComponent), 0x0010000000000005, CPP_BOOL_PROPERTY_BITMASK(TestRipple, UFluidSurfaceComponent), sizeof(bool), true);
				UProperty* NewProp_FluidNoiseStrength = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("FluidNoiseStrength"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(FluidNoiseStrength, UFluidSurfaceComponent), 0x0010000000000005, Z_Construct_UScriptStruct_FRangedValues());
				UProperty* NewProp_FluidNoiseFrequency = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("FluidNoiseFrequency"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(FluidNoiseFrequency, UFluidSurfaceComponent), 0x0010000000000005);
				UProperty* NewProp_FluidDamping = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("FluidDamping"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(FluidDamping, UFluidSurfaceComponent), 0x0010000000000005);
				UProperty* NewProp_FluidTimeScale = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("FluidTimeScale"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(FluidTimeScale, UFluidSurfaceComponent), 0x0010000000000005);
				UProperty* NewProp_FluidSpeed = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("FluidSpeed"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(FluidSpeed, UFluidSurfaceComponent), 0x0010000000000005);
				UProperty* NewProp_FluidHeightScale = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("FluidHeightScale"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(FluidHeightScale, UFluidSurfaceComponent), 0x0010000000000015);
				UProperty* NewProp_FluidYSize = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("FluidYSize"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(FluidYSize, UFluidSurfaceComponent), 0x0010000000000015);
				UProperty* NewProp_FluidXSize = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("FluidXSize"), RF_Public|RF_Transient|RF_MarkAsNative) UIntProperty(CPP_PROPERTY_BASE(FluidXSize, UFluidSurfaceComponent), 0x0010000000000015);
				UProperty* NewProp_FluidGridSpacing = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("FluidGridSpacing"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(FluidGridSpacing, UFluidSurfaceComponent), 0x0010000000000015);
				UProperty* NewProp_FluidGridType = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("FluidGridType"), RF_Public|RF_Transient|RF_MarkAsNative) UByteProperty(CPP_PROPERTY_BASE(FluidGridType, UFluidSurfaceComponent), 0x0010000000000015, Z_Construct_UEnum_FluidSurface_EFluidGridType());
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UFluidSurfaceComponent_ComponentTouched(), "ComponentTouched"); // 1014896941
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_UFluidSurfaceComponent_Pling(), "Pling"); // 3553954399
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	static FCompiledInDefer Z_CompiledInDefer_UClass_UFluidSurfaceComponent(Z_Construct_UClass_UFluidSurfaceComponent, &UFluidSurfaceComponent::StaticClass, TEXT("UFluidSurfaceComponent"), false, nullptr, nullptr);
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				UProperty* NewProp_SceneComponent = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("SceneComponent"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(SceneComponent, AFluidSurfaceModifier), 0x0010000000080008, Z_Construct_UClass_USceneComponent_NoRegister());
#if WITH_EDITORONLY_DATA
				UProperty* NewProp_SpriteComponent = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("SpriteComponent"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(SpriteComponent, AFluidSurfaceModifier), 0x0010000800080008, Z_Construct_UClass_UBillboardComponent_NoRegister());
#endif // WITH_EDITORONLY_DATA
				CPP_BOOL_PROPERTY_BITMASK_STRUCT(Active, AFluidSurfaceModifier, bool);
				UProperty* NewProp_Active = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("Active"), RF_Public|RF_Transient|RF_MarkAsNative) UBoolProperty(FObjectInitializer(), EC_CppProperty, CPP_BOOL_PROPERTY_OFFSET(Active, AFluidSurfaceModifier), 0x0010000000000005, CPP_BOOL_PROPERTY_BITMASK(Active, AFluidSurfaceModifier), sizeof(bool), true);
				UProperty* NewProp_FluidActor = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("FluidActor"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(FluidActor, AFluidSurfaceModifier), 0x0010000000000015, Z_Construct_UClass_AFluidSurfaceActor_NoRegister());
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	static FCompiledInDefer Z_CompiledInDefer_UClass_AFluidSurfaceModifier(Z_Construct_UClass_AFluidSurfaceModifier, &AFluidSurfaceModifier::StaticClass, TEXT("AFluidSurfaceModifier"), false, nullptr, nullptr);
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
#if WITH_EDITORONLY_DATA
				UProperty* NewProp_RadiusComponent = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("RadiusComponent"), RF_Public|RF_Transient|RF_MarkAsNative) UObjectProperty(CPP_PROPERTY_BASE(RadiusComponent, AFluidSurfaceOscillator), 0x0010000800080008, Z_Construct_UClass_USphereComponent_NoRegister());
#endif // WITH_EDITORONLY_DATA
				UProperty* NewProp_Radius = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("Radius"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(Radius, AFluidSurfaceOscillator), 0x0010000000000005);
				UProperty* NewProp_Strength = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("Strength"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(Strength, AFluidSurfaceOscillator), 0x0010000000000005);
				UProperty* NewProp_Phase = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("Phase"), RF_Public|RF_Transient|RF_MarkAsNative) UByteProperty(CPP_PROPERTY_BASE(Phase, AFluidSurfaceOscillator), 0x0010000000000005);
				UProperty* NewProp_Frequency = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("Frequency"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(Frequency, AFluidSurfaceOscillator), 0x0010000000000005);
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	static FCompiledInDefer Z_CompiledInDefer_UClass_AFluidSurfaceOscillator(Z_Construct_UClass_AFluidSurfaceOscillator, &AFluidSurfaceOscillator::StaticClass, TEXT("AFluidSurfaceOscillator"), false, nullptr, nullptr);
...
PRAGMA_DISABLE_DEPRECATION_WARNINGS
				UProperty* NewProp_Radius = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("Radius"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(Radius, AFluidSurfaceRain), 0x0010000000000005, Z_Construct_UScriptStruct_FRangedValues());
				UProperty* NewProp_Strength = new(EC_InternalUseOnlyConstructor, OuterClass, TEXT("Strength"), RF_Public|RF_Transient|RF_MarkAsNative) UStructProperty(CPP_PROPERTY_BASE(Strength, AFluidSurfaceRain), 0x0010000000000005, Z_Construct_UScriptStruct_FRangedValues());
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
	...
	static FCompiledInDefer Z_CompiledInDefer_UClass_AFluidSurfaceRain(Z_Construct_UClass_AFluidSurfaceRain, &AFluidSurfaceRain::StaticClass, TEXT("AFluidSurfaceRain"), false, nullptr, nullptr);
	DEFINE_VTABLE_PTR_HELPER_CTOR(AFluidSurfaceRain);
	UPackage* Z_Construct_UPackage__Script_FluidSurface()
	{
