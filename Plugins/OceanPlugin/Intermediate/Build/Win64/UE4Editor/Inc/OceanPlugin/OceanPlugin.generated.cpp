...
static struct FScriptStruct_OceanPlugin_StaticRegisterNativesFWaveParameter
{
	...
	IMPLEMENT_CLASS(AOceanManager, 1469633117);
	void UBuoyancyComponent::StaticRegisterNativesUBuoyancyComponent()
	{
	}
	IMPLEMENT_CLASS(UBuoyancyComponent, 553793314);
...
static struct FScriptStruct_OceanPlugin_StaticRegisterNativesFStructBoneOverride
{
	...
	IMPLEMENT_CLASS(ACustomVehicleController, 4156757348);
	void AFishManager::StaticRegisterNativesAFishManager()
	{
	}
	IMPLEMENT_CLASS(AFishManager, 2285719530);
	...
	IMPLEMENT_CLASS(AFlockFish, 3655074657);
...
static FCompiledInDeferEnum Z_CompiledInDeferEnum_UEnum_EFollowMethod(EFollowMethod_StaticEnum, TEXT("/Script/OceanPlugin"), TEXT("EFollowMethod"), false, nullptr, nullptr);
	...
	IMPLEMENT_CLASS(UInfiniteSystemComponent, 1413759665);
	void UWaterHeightmapComponent::StaticRegisterNativesUWaterHeightmapComponent()
	{
	}
	IMPLEMENT_CLASS(UWaterHeightmapComponent, 2130112413);
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				...
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_AOceanManager_GetWaveHeightValue(), "GetWaveHeightValue"); // 2491466603
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_AFlockFish_OnBeginOverlap(), "OnBeginOverlap"); // 4081970833
				OuterClass->AddFunctionToFunctionMapWithOverriddenName(Z_Construct_UFunction_AFlockFish_OnEndOverlap(), "OnEndOverlap"); // 4184168827
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
...
PRAGMA_ENABLE_DEPRECATION_WARNINGS
	...
	UScriptStruct* Z_Construct_UScriptStruct_FTimeDate()
	{
		...
		if (!ReturnStruct)
		{
			...
			UProperty* NewProp_Second = new(EC_InternalUseOnlyConstructor, ReturnStruct, TEXT("Second"), RF_Public|RF_Transient|RF_MarkAsNative) UFloatProperty(CPP_PROPERTY_BASE(Second, FTimeDate), 0x0010000000000005);
			ReturnStruct->StaticLink();
#if WITH_METADATA
			UMetaData* MetaData = ReturnStruct->GetOutermost()->GetMetaData();
			MetaData->SetValue(ReturnStruct, TEXT("BlueprintType"), TEXT("true"));
	...
	uint32 Get_Z_Construct_UScriptStruct_FTimeDate_CRC() { return 4275658739U; }
